module.exports = {
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb://localhost:27017/gauthtest',
    PARSE_APP_ID: process.env.PARSE_APP_ID || 'gauthtest',
    ...
    PARSE_DASHBOARD_APP_NAME: process.env.PARSE_DASHBOARD_APP_NAME || 'gauthtest',
